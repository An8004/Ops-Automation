...
public class Queries {
    ...
    public static final String CHECK_CALLING_SERVICE_LEADS_QUERY = "SELECT entity_id FROM calling_service_leads WHERE entity_id = (SELECT loan_application_no FROM loan_application WHERE id = ? ) AND campaign_id = 'VKYC_NOTRY'";
